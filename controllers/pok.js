...
pok.socket = function(io, connections, client) {
    ...
    client.on('put_unit', function(unt) {
        ...
        DetailBelanja.findOne({ _id: unt.id, 'thang': thang }, 'nmitem unit', function(err, unitdetail) {
            ...
            if (unitdetail) {
                DetailBelanja.update({ _id: unt.id, 'thang': thang }, { $set: { unit: unt.unit } }, { upsert: true }, function(err, status) {
                    if (err) {
                        errorHandler(client, 'Database error.');
                        return;
                    }
                    sendNotification(client, 'Unit telah ditambahkan');
                    console.log('berhasil');
                    // client.broadcast.to(thang).emit('title_change', pok_name);
                })
            } else {
                sendNotification(client, 'Maaf terjadi kesalahan');
                console.log('gagal');
            }
        })
    });
                                                            ...
                                                            if (filter != 0) {
                                                                ...
                                                                if (tabel == 'edit') {
                                                                    kegiatan_row = [
                                                                        kegiatan._id,
                                                                        program._id,
                                                                        '<span class="badge badge-default" title="Prog: ' + program.kdprogram + '">aktivitas</span>',
                                                                        kegiatan.kdgiat,
                                                                        kegiatan.uraian,
                                                                        '-',
                                                                        '-',
                                                                                                                            ...
                                                                                                                            if (filter != 0) {
                                                                                                                                ...
                                                                                                                                client.emit('pok_row_init_response', data, function() {
                                                                                                                                    ...
                                                                                                                                    Komponen.find({
                                                                                                                                        ...
                                                                                                                                        'kdprogram': program.kdprogram,
                                                                                                                                        'kdgiat': kegiatan.kdgiat,
                                                                                                                                        'kdoutput': soutput.kdsoutput,
                                                                                                                                        'kdoutput': output.kdoutput,
                                                                                                                                        active: true
                                                                                                                                    }).sort('kdkmpnen').exec(function(err, komponens) {
                                                                                                                                        //notif user jika ada error
                                                                                                                                        if (err) {
                                                                                                                                            errorHandler(client, 'Database Error. Mohon hubungi admin.');
                                                                                                                                            return;
                                                                                                                                                            ...
                                                                                                                                                            if (filter != 0) {
                                                                                                                                                                ...
                                                                                                                                                                client.emit('pok_row_init_response', data, function() {
                                                                                                                                                                    ...
                                                                                                                                                                    SubKomponen.find({
                                                                                                                                                                        ...
                                                                                                                                                                        'kdkmpnen': komponen.kdkmpnen,
                                                                                                                                                                        active: true
                                                                                                                                                                    }).sort('kdskmpnen').exec(function(err, skomponens) {
                                                                                                                                                                        //notif user jika ada error
                                                                                                                                                                        if (err) {
                                                                                                                                                                            errorHandler(client, 'Database Error. Mohon hubungi admin.');
                                                                                                                                                                            return;
                                                                                                                                                                                            ...
                                                                                                                                                                                            if (filter != 0) {
                                                                                                                                                                                                ...
                                                                                                                                                                                                client.emit('pok_row_init_response', data, function() {
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    Akun.find({
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        'kdskmpnen': skomponen.kdskmpnen,
                                                                                                                                                                                                        active: true
                                                                                                                                                                                                    }).sort('kdakun').exec(function(err, akuns) {
                                                                                                                                                                                                        //notif user jika ada error
                                                                                                                                                                                                        if (err) {
                                                                                                                                                                                                            errorHandler(client, 'Database Error. Mohon hubungi admin.');
                                                                                                                                                                                                            return;
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            if (filter != 0) {
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                client.emit('pok_row_init_response', data, function() {
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    DetailBelanja.find({
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        'kdakun': akun.kdakun,
                                                                                                                                                                                                                                        active: true
                                                                                                                                                                                                                                    }).sort('noitem').exec(function(err, details) {
                                                                                                                                                                                                                                        //notif user jika ada error
                                                                                                                                                                                                                                        if (err) {
                                                                                                                                                                                                                                            errorHandler(client, 'Database Error. Mohon hubungi admin.');
                                                                                                                                                                                                                                            return;
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        if (detail.nmitem.charAt(0) == '>') {
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            if (role == 15 || admin == 1) {
                                                                                                                                                                                                                                                                                detail_row = [
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    '<button type="button" class="entry" title="Input Realiasai"><i class="icon-plus"></i></button>' +
                                                                                                                                                                                                                                                                                    ' <button type="button" class="riwayat" title="Riwayat Realiasai"><i class="icon-list"></i></button>'
                                                                                                                                                                                                                                                                                ]
                                                                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                                                                detail_row = [
                                                                                                                                                                                                                                                                                    detail._id,
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        if (detail.nmitem.charAt(0) == '>') {
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            if (role == 15 || admin == 1) {
                                                                                                                                                                                                                                                                                detail_row = [
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    '<button type="button" class="entry" title="Input Realiasai"><i class="icon-plus"></i></button>' +
                                                                                                                                                                                                                                                                                    ' <button type="button" class="riwayat" title="Riwayat Realiasai"><i class="icon-list"></i></button>' +
                                                                                                                                                                                                                                                                                    ' <button type="button" class="refisi" title="Riwayat Detail"><i class="icon-clock"></i></button>'
                                                                                                                                                                                                                                                                                ]
                                                                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                                                                detail_row = [
                                                                                                                                                                                                                                                                                    detail._id,
    ...
    client.on('pok_delete_item', function(item) {
        ...
        removeItem(Model, { 'thang': thang, _id: item._id, 'active': true }, function(item_deleted) {
            ...
            if (item.type == 'program') {
                ...
                var syarat = {
                    'thang': thang,
                    'kdprogram': item_deleted.kdprogram,
                    'kdgiat': item_deleted.kdgiat,
                ...
                var syarat = {
                    ...
                    'kdgiat': item_deleted.kdgiat,
                    'kdoutput': item_deleted.kdoutput,
                    'kdsoutput': item_deleted.kdsoutput,
                    'active': true
                }
                removeItem(DetailBelanja, syarat, null);
                removeItem(Akun, syarat, null);
                ...
                var syarat = {
                    ...
                    'kdoutput': item_deleted.kdoutput,
                    'kdsoutput': item_deleted.kdsoutput,
                    'kdkmpnen': item_deleted.kdkmpnen,
                    'active': true
                }
                removeItem(DetailBelanja, syarat, null);
                removeItem(Akun, syarat, null);
    ...
    client.on('pok_edit_new_item', function(user_input, cb) {
        ...
        if (user_input.parent_type == 'akun') {
            Akun.findOne({ 'thang': thang, _id: user_input.parent_id, 'active': true }, function(err, parent) {
                ...
                Model.findOne({
                    'thang': thang,
                    kdprogram: parent.kdprogram,
                    kdgiat: user_input.kdgiat,
                    kdoutput: user_input.kdoutput,
                    kdsoutput: user_input.kdsoutput,
                    kdkmpnen: user_input.kdkmpnen,
                    kdskmpnen: user_input.kdskmpnen,
                    kdakun: user_input.kdakun,
                    nmitem: user_input.nmitem,
                    'active': true
                }, function(err, result) {
                    if (result) {
            ...
            SubOutput.findOne({ 'thang': thang, _id: user_input.parent_id, 'active': true }, function(err, parent) {
                ...
                Model.findOne({
                    'thang': thang,
                    kdprogram: user_input.kdprogram,
                    kdgiat: user_input.kdgiat,
                    kdoutput: user_input.kdoutput,
                    kdoutput: user_input.kdoutput,
                    kdsoutput: user_input.kdsoutput,
    ...
    client.on('entry_submit', function(new_entry, cb) {
                ...
                if (getNumber(item.jumlah)) {
                    ...
                    DetailBelanja.update({ 'thang': thang, "_id": new_entry._id }, { $push: { "realisasi": item } }, { new: true }, function(err, result) {
                        ...
                        if (item.tgl_timestamp >= lower_ts && item.tgl_timestamp <= upper_ts) {
                            ...
                            io.sockets.to(thang).emit('pok_entry_update_realisasi', {
                                'parent_id': new_entry._id,
                ...
                tasks.push(function(callback) {
                    ...
                    Pegawai.find({ active: true }, 'nama', function(err, pegs) {
                        ...
                        if (matched.score >= 0.91) {
                            ...
                            DetailBelanja.findOne({ 'thang': thang, '_id': new_entry._id, active: true }, 'realisasi').elemMatch('realisasi', {
                                'jumlah': item.jumlah,
        ...
        DetailBelanja.findOne({ 'thang': thang, '_id': new_entry._id, active: true }, 'realisasi').elemMatch('realisasi', {
            'jumlah': new_entry.data.jumlah,
            'penerima_id': new_entry.data.penerima_id,
            'tgl': new_entry.data.tgl,
            'ket': new_entry.data.ket
        }).exec(function(err, result) {
            //jika blm pernah
            if (!result) {
                        ...
                        CustomEntity.create({ 'nama': new_entry.data.penerima_nama, type: 'Penerima' }, function(err, new_penerima) {
                            ...
                            DetailBelanja.update({ 'thang': thang, "_id": new_entry._id }, { $push: { "realisasi": new_entry.data } }, { new: true }, function(err, result) {
                                ...
                                if (new_entry.data.tgl_timestamp >= lower_ts && new_entry.data.tgl_timestamp <= upper_ts) {
                                    ...
                                    io.sockets.to(thang).emit('pok_entry_update_realisasi', {
                                        'parent_id': new_entry._id,
                                        'realisasi': new_entry.data.jumlah,
                                        'sum': false,
                                        'total_sampai_bln_ini': total_sampai_bln_ini,
                                        'broadcast': true
                                    });
    ...
    client.on('riwayat_init', function(data, cb) {
        ...
        if (!data.call_from_pengguna) {
                ...
                function(err, detail) {
                    ...
                    if (data.init) {
                        if (!data.xlsx && !data.pdf) {
                            DetailBelanja.find({
                                'thang': thang,
                                'kdprogram': detail.kdprogram,
                                'kdgiat': detail.kdgiat,
                                'kdoutput': detail.kdoutput,
                                'kdsoutput': detail.kdsoutput,
                                'kdkmpnen': detail.kdkmpnen,
                                'kdskmpnen': detail.kdskmpnen,
                                'kdakun': detail.kdakun
                            }, 'noitem nmitem kdakun').sort('noitem').exec(function(err, details) {
                                Akun.find({
                                    'thang': thang,
                                    'kdprogram': detail.kdprogram,
                                    'kdgiat': detail.kdgiat,
                                    ...
                                    'kdkmpnen': detail.kdkmpnen,
                                    'kdskmpnen': detail.kdskmpnen
                                }, 'kdakun uraian kdskmpnen').sort('kdakun').exec(function(err, akuns) {
                                    SubKomponen.find({
                                        'thang': thang,
                                        'kdprogram': detail.kdprogram,
                                        'kdgiat': detail.kdgiat,
                                        ...
                                        'kdsoutput': detail.kdsoutput,
                                        'kdkmpnen': detail.kdkmpnen
                                    }, 'kdskmpnen urskmpnen kdkmpnen').sort('kdskmpnen').exec(function(err, skomps) {
                                        Komponen.find({
                                            'thang': thang,
                                            'kdprogram': detail.kdprogram,
                                            'kdgiat': detail.kdgiat,
                                            'kdoutput': detail.kdoutput,
                                            'kdsoutput': detail.kdsoutput
                                        }, 'kdkmpnen urkmpnen kdsoutput').sort('kdkmpnen').exec(function(err, komps) {
            ...
            DetailBelanja.find({
                'thang': thang,
                active: true,
                $or: [{ 'realisasi.penerima_id': data.penerima_id },
                    { 'realisasi.penerima_id': data.kode_dosen }, { 'realisasi.penerima_id': data.ce }
                ]
            }, 'nmitem realisasi', function(err, details) {
                var rows = [];
                _.each(details, function(detail, index, list) {
                    _.each(detail.realisasi, function(realisasi, index, list) {
                        if ((realisasi.penerima_id == data.penerima_id || realisasi.penerima_id == data.kode_dosen || realisasi.penerima_id == data.ce) &&
                            ...
                            if (data.xlsx || data.pdf) {
                                rows.push({
                                    tgl: realisasi.tgl,
                                    nmitem: detail.nmitem,
                                    jumlah: realisasi.jumlah,
                                    pph21: realisasi.pph21,
                                    pph22: realisasi.pph22,
                                    pph23: realisasi.pph23,
                                    ppn: realisasi.ppn,
                                    spm_no: realisasi.spm_no,
                                    bukti_no: realisasi.bukti_no,
                                    ket: realisasi.ket,
                                    pengentry: realisasi.pengentry
                                })
                            } else {
        ...
        DetailBelanja.findOne({ 'thang': thang, _id: id.parent_id }, 'realisasi', function(err, parent) {
            ...
            if (parent.realisasi.id(id.target_id).tgl_timestamp >= lower_ts && parent.realisasi.id(id.target_id).tgl_timestamp <= upper_ts) {
                io.sockets.to(thang).emit('pok_entry_update_realisasi', {
                    ...
                    'realisasi': -Math.abs(parent.realisasi.id(id.target_id).jumlah),
                    'sum': false,
                    'total_sampai_bln_ini': -Math.abs(parent.realisasi.id(id.target_id).jumlah),
                    'broadcast': true,
                    message: '1 item realisasi telah dihapus.'
                });
            ...
            if (id.new_parent_id) {
                ...
                DetailBelanja.findOne({ 'thang': thang, '_id': id.new_parent_id, active: true }, 'realisasi').elemMatch('realisasi', {
                    'jumlah': to_moved.jumlah,
                    'penerima_id': to_moved.penerima_id,
                    'tgl': to_moved.tgl
                }).exec(function(err, result) {
                    //jika blm pernah
                    if (!result) {
    ...
    client.on('riwayat_edit', function(user_input, cb) {
        DetailBelanja.findOneAndUpdate({ 'thang': thang, '_id': user_input.parent_id, 'realisasi._id': user_input.target_id }, { $set: user_input.data }, function(err, result) {
            if (err) {
                ...
                DetailBelanja.findOne({ _id: new ObjectId(detail_id) }, function(err, detail) {
                    if (detail) {
                        DetailBelanja.find({
                            ...
                            var new_detail = new DetailBelanja({
                                'thang': detail.thang,
                                'timestamp': timestamp,
                                pengentry: user_aktiv,
                                kdprogram: detail.kdprogram,
                                kdgiat: detail.kdgiat,
                                kdoutput: detail.kdoutput,
                                kdsoutput: detail.kdsoutput,
                                ...
                                _.each(outputs, function(outp, index, list) {
                                    tasks4.push(function(cb4) {
                                        ...
                                        Komponen.find({
                                            ...
                                            kdgiat: outp.kdgiat,
                                            kdprogram: outp.kdprogram
                                        }).sort('kdkmpnen').exec(function(err, komps) {
                                            var tasks3 = [];
                                            ...
                                            _.each(komps, function(komp, index, list) {
                                                tasks3.push(function(cb3) {
                                                    ...
                                                    SubKomponen.find({
                                                        ...
                                                        kdsoutput: komp.kdsoutput,
                                                        kdoutput: komp.kdoutput,
                                                        kdgiat: komp.kdgiat,
                                                        kdprogram: komp.kdprogram
                                                    }).sort('kdskmpnen').exec(function(err, skomps) {
                                                        var tasks2 = [];
                                                        ...
                                                        _.each(skomps, function(skomp, index, list) {
                                                            tasks2.push(function(cb2) {
                                                                ...
                                                                Akun.find({
                                                                    ...
                                                                    kdkmpnen: skomp.kdkmpnen,
                                                                    kdsoutput: skomp.kdsoutput,
                                                                    kdoutput: skomp.kdoutput,
                                                                    kdgiat: skomp.kdgiat,
                                                                    kdprogram: skomp.kdprogram
                                                                }).sort('kdakun').exec(function(err, akuns) {
                                                                    var tasks1 = [];
        ...
        if (result) {
            ...
            if (!_.isEmpty(old)) {
                ...
                Model.update({ _id: new ObjectId(result['_id']) }, { $set: new_item }, function(err, updated) {
                    if (err) errorHandler(user_id, result['_id'] + ' update error. Mohon hubungi admin.');
                    if (item.nmitem) {
                        pok.connections[user_id].emit('pok_unduh_finish_xlsx_add_change', [result['_id'], '<span class="badge badge-success">update</span>', item.kdprogram + '>' + item.kdgiat + '>' + item.kdoutput + '>' + item.kdsoutput + '>' + item.kdkmpnen + '>' + item.kdskmpnen + '>' + item.kdakun,
            ...
            tasks.push(
                function(cb) {
                    ...
                    async.series([
                        ...
                        function(cb_akun) {
                            DetailBelanja.find({
                                kdprogram: current_kdprogram,
                                kdgiat: current_kdgiat,
                                kdoutput: current_kdoutput,
                                kdsoutput: current_kdsoutput,
                                kdkmpnen: current_kdkmpnen,
                                kdskmpnen: new_item.kdskmpnen,
                                kdakun: new_item.kdakun
                            }, function(err, ds) {
                                if (ds) {
                                    details_list = ds;
                                } else {
                ...
                function(cb) {
                    ...
                    if (details_list.length == 0) { //jika blm pernah ada detail yg diupload
                        ...
                        new_detail.save(function(err, det) {
                            cb(null, '')
                            pok.connections[user_id].emit('pok_unduh_finish_xlsx_add_change', [new_detail._id, '<span class="badge badge-primary">baru</span>', new_detail.kdprogram + '>' + new_detail.kdgiat + '>' + new_detail.kdoutput + '>' + new_detail.kdsoutput + '>' + new_detail.kdkmpnen + '>' + new_detail.kdskmpnen + '>' + new_detail.kdakun, new_detail.nmitem,
                            ...
                            function(cb_d) {
                                if (matched) {
                                    ...
                                    if (!_.isEmpty(old)) {
                                        ...
                                        DetailBelanja.update({ _id: new ObjectId(matched['_id']) }, { $set: new_item }, function(err, updated) {
                                            ...
                                            if (old.nmitem || old.volkeg || old.satkeg || old.hargasat || old.jumlah) {
                                                pok.connections[user_id].emit('pok_unduh_finish_xlsx_add_change', [matched['_id'], '<span class="badge badge-success">update</span>', new_item.kdprogram + '>' + new_item.kdgiat + '>' + new_item.kdoutput + '>' + new_item.kdsoutput + '>' + new_item.kdkmpnen + '>' + new_item.kdskmpnen + '>' + new_item.kdakun,
                                    ...
                                    detail.save(function(err, det) {
                                        cb_d(null, '')
                                        pok.connections[user_id].emit('pok_unduh_finish_xlsx_add_change', [detail._id, '<span class="badge badge-primary">baru</span>', detail.kdprogram + '>' + detail.kdgiat + '>' + detail.kdoutput + '>' + detail.kdsoutput + '>' + detail.kdkmpnen + '>' + detail.kdskmpnen + '>' + detail.kdakun, detail.nmitem,
                            ...
                            Program.find({ 'thang': thang, active: true, uraian: { $exists: false } }).sort('kdprogram').exec(function(err, progs) {
                                Kegiatan.find({ 'thang': thang, active: true, uraian: { $exists: false } }).sort('kdgiat').exec(function(err, kegs) {
                                    Akun.find({ 'thang': thang, active: true, uraian: { $exists: false } }).distinct('kdakun', function(err, akuns) {
                                        pok.connections[user_id].emit('pok_unduh_finish', {
                                            'progs': progs,
                                            'kegs': kegs,
